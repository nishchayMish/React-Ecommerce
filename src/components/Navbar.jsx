...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-5 font-medium'>
      ...
      {/* mobile wala */}
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${sidebarVisible ? 'w-full' : 'w-0'}`}>
          <div className='flex flex-col text-gray-600'>
            <div onClick={()=>setSidebarVisible(false)}
            className='flex items-center gap-4 p-3 cursor-pointer overflow-hidden'>
            ...
            <NavLink onClick={()=>setSidebarVisible(false)} to='/contact' className='py-2 pl-6 border'>CONTACT</NavLink>
          </div>
      </div>
